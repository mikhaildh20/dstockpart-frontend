...
export default function EditPartPage(){
    ...
    const loadData = useCallback(async () => {
        try{
            ...
            const response = await fetchData(`parts/${id}`, {}, "GET");
            ...
            Toast.error(err.message || "An error occurred while fetching part data");
            router.back();
        }finally{
            setLoading(false);
        }
        ...
        async (e) => {
            ...
            try {
                ...
                if(!data.error){
                    ...
                    Toast.error(data.message || "An error occurred while updating part data");
                    setLoading(false);
                }
            }catch (err) {
                Toast.error(err.message || "An error occurred while updating part data");
                setLoading(false);
            }
        },
