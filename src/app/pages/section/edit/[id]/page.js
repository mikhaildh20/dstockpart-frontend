...
export default function EditSectionPage(){
    ...
    const loadData = useCallback(async () => {
        try{
            ...
            const response = await fetchData(`sections/${id}`, {}, "GET");
            ...
            Toast.error(err.message || "An error occurred while fetching section data");
            router.back();
        }finally{
            setLoading(false);
        }
        ...
        async (e) => {
            ...
            try {
                ...
                if(!data.error){
                    ...
                    Toast.error(data.message || "An error occurred while updating section data");
                    setLoading(false);
                }
            }catch (err) {
                Toast.error(err.message || "An error occurred while updating section data");
                setLoading(false);
            }
        },
